...
MatrixXd TorqueOptCase1(double q[7]);                                   //Torque minimization gradient of cost function computation CASE1
...

{
    ...
    double pinit[6], pend[6], pdesired[6], dqdesired[7], command_tau[7];
    //pinit[0]=0.757;
    pinit[0]=0.75;
    pinit[1]=-0.4;
    pinit[2]=0.3;
	...
	*/
	...
	{  	
        ...
        */
        ...
        drtorque = drtorque + Tau_I.transpose()*Tau_I*0.001;
