...
void inversedynamics_torqueopt()
{
    ...
    */
    ...
    //ddqd = Mpinv_Jacob*(ddpd + kp_matrix_6*(pd - currentp) + kd_matrix_6*(dpd - currentdp) - DiffJacob*dqd) - (I7-Mpinv_Jacob*Jacob)*(50*Mass.inverse()*(Coriolis) - 0.021*ddy1); //0.014
...

{
    ...
    */
    ...
    lamda = 0.12; //damping coefficient
