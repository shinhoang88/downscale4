...

{
    ...
    */
    ...
    for(int k=0; k<200; k++)
    {
        ...
        ddqd = pinv_Jacob*(ddpd + kp_matrix_6*pderror + kd_matrix_6*dpderror - DiffJacob*current_dq);
    ...
    t_acc = 0.001;      //accelerate from 0-3s; decelerate from 7-10
    N_portion = 3;
